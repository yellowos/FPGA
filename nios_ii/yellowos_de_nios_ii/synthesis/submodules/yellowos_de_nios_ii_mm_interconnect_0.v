// yellowos_de_nios_ii_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module yellowos_de_nios_ii_mm_interconnect_0 (
	...
	wire  [103:0] jtag_avalon_jtag_slave_agent_rf_source_data;                                        // jtag_avalon_jtag_slave_agent:rf_source_data -> jtag_avalon_jtag_slave_agent_rsp_fifo:in_data
	...
	wire  [103:0] jtag_avalon_jtag_slave_agent_rsp_fifo_out_data;                                     // jtag_avalon_jtag_slave_agent_rsp_fifo:out_data -> jtag_avalon_jtag_slave_agent:rf_sink_data
	...
	wire  [102:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> jtag_avalon_jtag_slave_agent:cp_data
	...
	wire   [26:0] vic_0_csr_access_agent_m0_address;                                                  // vic_0_csr_access_agent:m0_address -> vic_0_csr_access_translator:uav_address
	...
	wire  [103:0] vic_0_csr_access_agent_rf_source_data;                                              // vic_0_csr_access_agent:rf_source_data -> vic_0_csr_access_agent_rsp_fifo:in_data
	...
	wire  [103:0] vic_0_csr_access_agent_rsp_fifo_out_data;                                           // vic_0_csr_access_agent_rsp_fifo:out_data -> vic_0_csr_access_agent:rf_sink_data
	...
	wire  [102:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> vic_0_csr_access_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                              // vic_0_csr_access_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [6:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> vic_0_csr_access_agent:cp_channel
	...
	wire    [6:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> epcs_flash_controller_0_epcs_control_port_agent:cp_channel
	...
	wire  [102:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> nios2_qsys_0_jtag_debug_module_agent:cp_data
	...
	wire  [102:0] jtag_avalon_jtag_slave_agent_rp_data;                                               // jtag_avalon_jtag_slave_agent:rp_data -> router_002:sink_data
	...
	wire          vic_0_csr_access_agent_rp_valid;                                                    // vic_0_csr_access_agent:rp_valid -> router_004:sink_valid
	wire  [102:0] vic_0_csr_access_agent_rp_data;                                                     // vic_0_csr_access_agent:rp_data -> router_004:sink_data
	wire          vic_0_csr_access_agent_rp_ready;                                                    // router_004:sink_ready -> vic_0_csr_access_agent:rp_ready
	wire          vic_0_csr_access_agent_rp_startofpacket;                                            // vic_0_csr_access_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          vic_0_csr_access_agent_rp_endofpacket;                                              // vic_0_csr_access_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [102:0] nios2_qsys_0_jtag_debug_module_agent_rp_data;                                       // nios2_qsys_0_jtag_debug_module_agent:rp_data -> router_006:sink_data
	...
	wire  [102:0] router_src_data;                                                                    // router:src_data -> nios2_qsys_0_data_master_limiter:cmd_sink_data
	...
	wire  [102:0] nios2_qsys_0_data_master_limiter_cmd_src_data;                                      // nios2_qsys_0_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [102:0] rsp_mux_src_data;                                                                   // rsp_mux:src_data -> nios2_qsys_0_data_master_limiter:rsp_sink_data
	...
	wire  [102:0] nios2_qsys_0_data_master_limiter_rsp_src_data;                                      // nios2_qsys_0_data_master_limiter:rsp_src_data -> nios2_qsys_0_data_master_agent:rp_data
	...
	wire  [102:0] router_001_src_data;                                                                // router_001:src_data -> nios2_qsys_0_instruction_master_limiter:cmd_sink_data
	...
	wire  [102:0] nios2_qsys_0_instruction_master_limiter_cmd_src_data;                               // nios2_qsys_0_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire  [102:0] rsp_mux_001_src_data;                                                               // rsp_mux_001:src_data -> nios2_qsys_0_instruction_master_limiter:rsp_sink_data
	...
	wire  [102:0] nios2_qsys_0_instruction_master_limiter_rsp_src_data;                               // nios2_qsys_0_instruction_master_limiter:rsp_src_data -> nios2_qsys_0_instruction_master_agent:rp_data
	...
	yellowos_de_nios_ii_mm_interconnect_0_router router (
	...
	yellowos_de_nios_ii_mm_interconnect_0_router_001 router_001 (
	...
	yellowos_de_nios_ii_mm_interconnect_0_router_002 router_002 (
	...
	yellowos_de_nios_ii_mm_interconnect_0_router_002 router_003 (
	...
	yellowos_de_nios_ii_mm_interconnect_0_router_002 router_004 (
	...
	yellowos_de_nios_ii_mm_interconnect_0_router_005 router_005 (
	...
	yellowos_de_nios_ii_mm_interconnect_0_router_005 router_006 (
	...
	yellowos_de_nios_ii_mm_interconnect_0_router_007 router_007 (
	...
	yellowos_de_nios_ii_mm_interconnect_0_router_002 router_008 (
	...
	yellowos_de_nios_ii_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                          //        clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset),       //  clk_reset.reset
	...
	yellowos_de_nios_ii_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                                 //        clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset),              //  clk_reset.reset
	...
	yellowos_de_nios_ii_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	yellowos_de_nios_ii_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	yellowos_de_nios_ii_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	yellowos_de_nios_ii_mm_interconnect_0_cmd_mux_003 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	yellowos_de_nios_ii_mm_interconnect_0_cmd_mux_003 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	yellowos_de_nios_ii_mm_interconnect_0_cmd_mux_003 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	yellowos_de_nios_ii_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	yellowos_de_nios_ii_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	yellowos_de_nios_ii_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	yellowos_de_nios_ii_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	yellowos_de_nios_ii_mm_interconnect_0_rsp_demux_003 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	yellowos_de_nios_ii_mm_interconnect_0_rsp_demux_003 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	yellowos_de_nios_ii_mm_interconnect_0_rsp_demux_003 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	yellowos_de_nios_ii_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	yellowos_de_nios_ii_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	yellowos_de_nios_ii_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	yellowos_de_nios_ii_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	yellowos_de_nios_ii_mm_interconnect_0_avalon_st_adapter_005 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
